 ...
 * @author Safsaf
 */
public class GUIService extends Form {

    private ImageViewer imge;
    private Image im;

    public GUIService(Resources theme) {
        ...
        ArrayList<Services> annonces = ser.getAllservice();
       ...
       //     background.fetch();
         ...
         EncodedImage palceHolder = EncodedImage.createFromImage(theme.getImage("logo.png"), false);
            ...
            c1.add(new Label("Titre: \n"+annonce.getTitre()));
                    ...
                    c1.add(new Label("Telephone: "));
                    c1.add(annonce.getTelephone());
